    ...
    return <>
        <div className="navBarContainer">
            ...
            <div className="navBarPrivateDetails">
                <h3 className="firstNameAndLastName">{selector.firstName} {selector.lastName}</h3>
                <Avatar 
                onClick={handleMenu}
                sx={{
                    curser: 'pointer'
              ...
              >
                ...
                <MenuItem onClick={handlePrivateArea}><AccountCircleOutlinedIcon/>&nbsp; My account</MenuItem>
                <MenuItem onClick={handleLogout}><MeetingRoomOutlinedIcon/> &nbsp; Log out</MenuItem>
              </Menu>
            </div>
            </div>}
